...
% x_range = linspace(-0.15, 0.15, 7);   % Example range for x
% y_range = linspace(-0.15, 0.15, 7);   % Example range for y
% z_range = linspace(-0.15, 0.15, 7);   % Example range for z
% Rx_range = deg2rad(linspace(-30, 30, 6));  % Example range for Rx
% Ry_range = deg2rad(linspace(-30, 30, 6));  % Example range for Ry
% Rz_range = deg2rad(linspace(-30, 30, 6));  % Example range for Rz
% 
