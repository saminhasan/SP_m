...
platform.orientation = deg2rad([0, 120, 240]); % Corner directions referenced to z !! First corner in z direction!!
...
[hexapod.y_home, hexapod.q_init] = calcHomePose(hexapod);
